(ns user
  ...
  (:require [clojure.java.javadoc :refer [javadoc]]
            ...
            [com.example.friboo-is-awesome.core :as core]
...
(defn start
  ...
  (#'system/set-log-level! "DEBUG" :logger-name "com.example.friboo_is_awesome")
...
(defn run-tests []
  (run-all-tests #"com.example.friboo-is-awesome.*-test"))
